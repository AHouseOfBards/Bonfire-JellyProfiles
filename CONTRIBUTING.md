...
`tests/run.sh` builds the plugin with warnings as errors and runs all 18 harnesses (14
JavaScript, 4 C#, about 820 assertions). Pull requests run exactly that, so if it is green
